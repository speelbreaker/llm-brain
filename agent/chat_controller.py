...
class ChatController:
    ...
    def _call_with_tools(self, messages: List[Dict[str, str]]) -> ChatResponse:
        ...
        if use_responses_api:
            return self._call_responses_api_with_tools(
                client, model, full_messages, tools_used
            )
        else:
            return self._call_chat_completions_with_tools(
                client, model, full_messages, tools_used
            )
