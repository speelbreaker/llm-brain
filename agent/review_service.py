...
from agent.analyzers import analyze_changes
...
class ReviewService:
    ...
    def _build_summary_md(
        ...
        if llm_result.issues:
            ...
            critical = sum(
                1 for i in llm_result.issues if i.get("severity") == "CRITICAL"
            )
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        current_head = (
            self.change_detector.get_current_head() if git_available else None
        )
