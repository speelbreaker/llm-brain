...
class TestApplyStrategyOverrides:
    ...
    def test_gregbot_ignores_dte_delta_targets(self):
        ...
        assert result.effective_config["target_delta"] == GREGBOT_DEFAULTS["target_delta"]
    ...
    def test_unknown_selector_warning(self):
        ...
        result = apply_strategy_overrides("unknown_strategy", {"exit_style": "hold_to_expiry"})
    ...
    def test_overrides_applied_tracking(self):
        ...
        assert result.overrides_applied["exit_style"]["effective_value"] == "gregbot_managed"
